...
Aya is a replicated state machine using the the Stellar Consensus Protocol. It's almost the same as Stellar, but with some differences that I believe will put Aya into a position to become the easiest and most accessible blockchain in the world.
